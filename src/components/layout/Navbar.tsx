    ...
    >
      <div className="mx-auto max-w-6xl h-full px-4 flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <button
            aria-label="알림"
            className="p-2 rounded-pill text-[var(--color-neutral-500)] hover:text-[var(--color-primary)] hover:bg-[var(--color-neutral-100)] transition-fast hover:cursor-pointer"
          >
            <BellIcon />
          </button>
          ...
          {user && (
            <div className="flex items-center mr-2">
              <button
                ...
                className="text-sm text-[var(--color-neutral-500)] hover:text-[var(--color-primary)] transition-fast hover:cursor-pointer"
              >
                LogOut
              </button>
            </div>
